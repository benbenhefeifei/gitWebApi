...
{
    using Cryptography;
    public class HmacSHA1: ISecurity
    {
        private HMACSHA1 hamcSha1 = null;
        ...
        public string Encrypt(string text, string key = "")
        {
            ...
            hamcSha1 = new HMACSHA1();
            if (!string.IsNullOrEmpty(key))
            {
                hamcSha1 = new HMACSHA1(DefCoding.GetBytes(key));
            }
            byte[] tmpByte = hamcSha1.ComputeHash(DefCoding.GetBytes(text));
        ...
        {
            throw new NotImplementedException("HmacSHA1暂不支持解密功能.");
        }
        /// <summary>
        /// 密码验证
        /// </summary>
