...
{
    using Cryptography;
    public class Sha1 : ISecurity
    {
        private SHA1 sha1Header = null;
        ...
        public string Encrypt(string text, string key = "")
        {
            ...
            sha1Header = new SHA1CryptoServiceProvider();
            byte[] tmpByte = sha1Header.ComputeHash(DefCoding.GetBytes(text));
        ...
        {
            throw new NotImplementedException("SHA1暂不支持解密功能.");
        }
        /// <summary>
        /// 密码验证
        /// </summary>
