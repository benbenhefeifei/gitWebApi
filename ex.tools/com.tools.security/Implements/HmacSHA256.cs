...
{
    using Cryptography;
    public class HmacSHA256: ISecurity
    {
        private HMACSHA256 hamcSha256 = null;
        ...
        public string Encrypt(string text, string key = "")
        {
            ...
            hamcSha256 = new HMACSHA256();
            if (!string.IsNullOrEmpty(key))
            {
                hamcSha256 = new HMACSHA256(DefCoding.GetBytes(key));
            }
            byte[] tmpByte = hamcSha256.ComputeHash(DefCoding.GetBytes(text));
        ...
        {
            throw new NotImplementedException("HmacSHA256暂不支持解密功能.");
        }
        /// <summary>
        /// 密码验证
        /// </summary>
