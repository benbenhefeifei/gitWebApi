...
{
    using Cryptography;
    public class Sha256 : ISecurity
    {
        private SHA256 sha256Header = null;
        ...
        public string Encrypt(string text, string key = "")
        {
            ...
            sha256Header = new SHA256CryptoServiceProvider();
            byte[] tmpByte = sha256Header.ComputeHash(DefCoding.GetBytes(text));
        ...
        {
            throw new NotImplementedException("SHA256暂不支持解密功能.");
        }
        /// <summary>
        /// 密码验证
        /// </summary>
