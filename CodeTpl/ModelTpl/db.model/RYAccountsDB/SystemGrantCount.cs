...
{
    /// <summary>
    /// SystemGrantCount ---  - 据实体模型（可扩展）
    /// </summary>
    [Serializable]
    [Table("SystemGrantCount")]
    public partial class SystemGrantCount // : IAggregateRoot
    {
        #region 私有变量
        /// <summary>
        /// 
        ...
        /// 获取或设置 注册地址
        /// </summary>
        [DatabaseGenerated(DatabaseGeneratedOption.None)][Key][Column("RegisterIP")]
