...
namespace hh.storage.RYAccountsDB
{
    ...
    ///  - 数据仓储服务（可扩展）
    /// </summary>
    public partial class UserTMPDAL : GenericRepository<model.RYAccountsDB.UserTMP>, IRepository<model.RYAccountsDB.UserTMP>
    {
        public UserTMPDAL() : base("RYAccountsDB")
        {
            base.DbTable.Name = "Table_User_TMP";
