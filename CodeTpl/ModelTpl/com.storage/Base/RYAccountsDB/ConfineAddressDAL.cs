...
namespace hh.storage.RYAccountsDB
{
    ...
    ///  - 数据仓储服务（可扩展）
    /// </summary>
    public partial class ConfineAddressDAL : GenericRepository<model.RYAccountsDB.ConfineAddress>, IRepository<model.RYAccountsDB.ConfineAddress>
    {
        public ConfineAddressDAL() : base("RYAccountsDB")
        {
            base.DbTable.Name = "ConfineAddress";
            base.DbTable.PKey = "AddrString";
